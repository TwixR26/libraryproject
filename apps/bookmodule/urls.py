...
urlpatterns = [
    ...
    path('lab11/task1/students', views.list_students, name='lab11_task1.list'),
    path('lab11/task1/add', views.add_student, name='lab11_task1.add'),
    path('lab11/task1/edit/<int:id>', views.edit_student, name='lab11_task1.edit'),
    path('lab11/task1/delete/<int:id>', views.delete_student, name='lab11_task1.delete'),
    path('lab11/task2/students', views.list_students2, name='lab11_task2.list'),
    path('lab11/task2/add', views.add_student2, name='lab11_task2.add'),
    path('lab11/task2/edit/<int:id>', views.edit_student2, name='lab11_task2.edit'),
    path('lab11/task2/delete/<int:id>', views.delete_student2, name='lab11_task2.delete'),
    path('lab11/task3/profiles', views.list_profiles, name='lab11_task3.list'),
    path('lab11/task3/add', views.add_profile, name='lab11_task3.add'),
]